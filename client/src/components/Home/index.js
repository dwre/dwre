  ...
  getActivityComponent(activity) {
    switch (activity.type) {
      ...
      case 'RECEIVE_FILE':
        ...
        return (
          <div>
            <Username username={activity.username} /> отправил вам <a target="_blank" href={downloadUrl} rel="noopener noreferrer">Download {activity.fileName}</a>
      ...
      case 'SEND_FILE':
        ...
        return (
          <Notice>
            <div>отправлено <a target="_blank" href={url} rel="noopener noreferrer">{activity.fileName}</a></div>
            {this.getFileDisplay(activity)}
          </Notice>
        )
      default:
        ...
        <div className="nav-container">
          {!this.props.socketConnected &&
            <div className="alert-banner">
              <span className="icon"><AlertCircle size="15" /></span> Отключено
            </div>
          }
          <Nav
